...
class MarkdownEngine {
    constructor(args) {
        ...
        this.headings = [];
        this.tocHTML = "";
        this.md = new MarkdownIt(Object.assign({}, defaults, { typographer: this.enableTypographer, breaks: this.breakOnSingleNewLine, linkify: this.enableLinkify }));
    ...
    */
     ...
     */
    generateScriptsForPreview(isForPresentation = false, yamlConfig = {}, isForVSCode = false) {
        let scripts = "";
        // prevent `id="exports"` element from linked to `window` object.
        scripts += `<script>var exports = undefined</script>`;
        // jquery
        scripts += `<script type="text/javascript" src="${utility.addFileProtocol(path.resolve(utility.extensionDirectoryPath, "./dependencies/jquery/jquery.js"), isForVSCode)}" charset="UTF-8"></script>`;
        // jquery contextmenu
        scripts += `<script type="text/javascript" src="${utility.addFileProtocol(path.resolve(utility.extensionDirectoryPath, "./dependencies/jquery-contextmenu/jquery.ui.position.min.js"), isForVSCode)}" charset="UTF-8"></script>`;
        scripts += `<script type="text/javascript" src="${utility.addFileProtocol(path.resolve(utility.extensionDirectoryPath, "./dependencies/jquery-contextmenu/jquery.contextMenu.min.js"), isForVSCode)}" charset="UTF-8"></script>`;
        // jquery modal
        scripts += `<script type="text/javascript" src="${utility.addFileProtocol(path.resolve(utility.extensionDirectoryPath, "./dependencies/jquery-modal/jquery.modal.min.js"), isForVSCode)}" charset="UTF-8"></script>`;
        // crpto-js
        scripts += `<script type="text/javascript" src="${utility.addFileProtocol(path.resolve(utility.extensionDirectoryPath, "./dependencies/crypto-js/crypto-js.js"), isForVSCode)}" charset="UTF-8"></script>`;
        // mermaid
        scripts += `<script type="text/javascript" src="${utility.addFileProtocol(path.resolve(utility.extensionDirectoryPath, `./dependencies/mermaid/mermaid.min.js`), isForVSCode)}" charset="UTF-8"></script>`;
        // wavedrome
        scripts += `<script type="text/javascript" src="${utility.addFileProtocol(path.resolve(utility.extensionDirectoryPath, "./dependencies/wavedrom/default.js"), isForVSCode)}" charset="UTF-8"></script>`;
        scripts += `<script type="text/javascript" src="${utility.addFileProtocol(path.resolve(utility.extensionDirectoryPath, "./dependencies/wavedrom/wavedrom.min.js"), isForVSCode)}" charset="UTF-8"></script>`;
        // math
        if (this.config.mathRenderingOption === "MathJax" ||
            ...
            scripts += `<script type="text/javascript" async src="${utility.addFileProtocol(path.resolve(utility.extensionDirectoryPath, "./dependencies/mathjax/MathJax.js"), isForVSCode)}" charset="UTF-8"></script>`;
            scripts += `<script type="text/x-mathjax-config"> MathJax.Hub.Config(${JSON.stringify(mathJaxConfig)}); </script>`;
        }
        // reveal.js
        if (isForPresentation) {
            scripts += `<script src='${utility.addFileProtocol(path.resolve(utility.extensionDirectoryPath, "./dependencies/reveal/lib/js/head.min.js"), isForVSCode)}'></script>`;
            scripts += `<script src='${utility.addFileProtocol(path.resolve(utility.extensionDirectoryPath, "./dependencies/reveal/js/reveal.js"), isForVSCode)}'></script>`;
...
if (typeof(window['Reveal']) !== 'undefined') {
  ...
  WaveDrom.ProcessAll()
        ...
        // flowchart.js
        scripts += `<script src='${utility.addFileProtocol(path.resolve(utility.extensionDirectoryPath, "./dependencies/raphael/raphael.js"), isForVSCode)}'></script>`;
        scripts += `<script src='${utility.addFileProtocol(path.resolve(utility.extensionDirectoryPath, "./dependencies/flowchart/flowchart.min.js"), isForVSCode)}'></script>`;
      ...
      for (var i = 0; i < flowcharts.length; i++) {
        ...
        scripts += `<script src="${utility.addFileProtocol(path.resolve(utility.extensionDirectoryPath, `./dependencies/vega/vega.min.js`), isForVSCode)}" charset="UTF-8"></script>`;
        scripts += `<script src="${utility.addFileProtocol(path.resolve(utility.extensionDirectoryPath, `./dependencies/vega-lite/vega-lite.min.js`), isForVSCode)}" charset="UTF-8"></script>`;
        scripts += `<script src="${utility.addFileProtocol(path.resolve(utility.extensionDirectoryPath, `./dependencies/vega-embed/vega-embed.min.js`), isForVSCode)}" charset="UTF-8"></script>`;
        if (isForPresentation) {
            scripts += `<script>
      ...
      for (var i = 0; i < vegaEls.length; i++) {
        ...
        // sequence diagram
        scripts += `<script src='${utility.addFileProtocol(path.resolve(utility.extensionDirectoryPath, "./dependencies/webfont/webfontloader.js"), isForVSCode)}'></script>`;
        scripts += `<script src='${utility.addFileProtocol(path.resolve(utility.extensionDirectoryPath, "./dependencies/underscore/underscore.js"), isForVSCode)}'></script>`;
        scripts += `<script src='${utility.addFileProtocol(path.resolve(utility.extensionDirectoryPath, "./dependencies/js-sequence-diagrams/sequence-diagram-min.js"), isForVSCode)}'></script>`;
     ...
     */
    generateStylesForPreview(isPresentationMode = false, yamlConfig = {}, isForVSCode = false) {
        let styles = "";
        // loading.css
        styles += `<link rel="stylesheet" href="${utility.addFileProtocol(path.resolve(utility.extensionDirectoryPath, "./styles/loading.css"), isForVSCode)}">`;
        // jquery-contextmenu
        styles += `<link rel="stylesheet" href="${utility.addFileProtocol(path.resolve(utility.extensionDirectoryPath, `./dependencies/jquery-contextmenu/jquery.contextMenu.min.css`), isForVSCode)}">`;
        // jquery-modal
        styles += `<link rel="stylesheet" href="${utility.addFileProtocol(path.resolve(utility.extensionDirectoryPath, `./dependencies/jquery-modal/jquery.modal.min.css`), isForVSCode)}">`;
        // check math
        if (this.config.mathRenderingOption === "KaTeX" &&
            !this.config.usePandocParser) {
            styles += `<link rel="stylesheet" href="${utility.addFileProtocol(path.resolve(utility.extensionDirectoryPath, "./dependencies/katex/katex.min.css"), isForVSCode)}">`;
        }
        // check sequence diagram
        styles += `<link rel="stylesheet" href="${utility.addFileProtocol(path.resolve(utility.extensionDirectoryPath, `./dependencies/js-sequence-diagrams/sequence-diagram-min.css`), isForVSCode)}">`;
        // check font-awesome
        styles += `<link rel="stylesheet" href="${utility.addFileProtocol(path.resolve(utility.extensionDirectoryPath, `./dependencies/font-awesome/css/font-awesome.min.css`), isForVSCode)}">`;
        // check preview theme and revealjs theme
        if (!isPresentationMode) {
            styles += `<link rel="stylesheet" href="${utility.addFileProtocol(path.resolve(utility.extensionDirectoryPath, `./styles/preview_theme/${this.config.previewTheme}`), isForVSCode)}">`;
        }
        else {
            styles += `<link rel="stylesheet" href="${utility.addFileProtocol(path.resolve(extensionDirectoryPath, "./dependencies/reveal/css/reveal.css"), isForVSCode)}" >`;
            styles += `<link rel="stylesheet" href="${utility.addFileProtocol(path.resolve(extensionDirectoryPath, `./dependencies/reveal/css/theme/${yamlConfig["presentation"] &&
                ...
                yamlConfig["presentation"]["theme"]
                ? yamlConfig["presentation"]["theme"]
                : this.config.revealjsTheme}`), isForVSCode)}" >`;
        }
        // check prism
        styles += `<link rel="stylesheet" href="${utility.addFileProtocol(path.resolve(utility.extensionDirectoryPath, `./styles/prism_theme/${this.getPrismTheme(isPresentationMode, yamlConfig)}`), isForVSCode)}">`;
        // style template
        styles += `<link rel="stylesheet" media="screen" href="${utility.addFileProtocol(path.resolve(utility.extensionDirectoryPath, "./styles/style-template.css"), isForVSCode)}">`;
        // global styles
     ...
     * @param JSAndCssFiles
     */
    generateJSAndCssFilesForPreview(JSAndCssFiles = [], isForVSCode = false) {
        let output = "";
        JSAndCssFiles.forEach((sourcePath) => {
            let absoluteFilePath = sourcePath;
            if (sourcePath[0] === "/") {
                absoluteFilePath = utility.addFileProtocol(path.resolve(this.projectDirectoryPath, "." + sourcePath), isForVSCode);
            }
                ...
                absoluteFilePath = utility.addFileProtocol(path.resolve(this.fileDirectoryPath, sourcePath), isForVSCode);
            }
     ...
     */
    generateHTMLTemplateForPreview({ inputString = "", body = "", webviewScript = "", scripts = "", styles = "", head = `<base href="${this.filePath}">`, config = {}, isForVSCode = false, contentSecurityPolicy = "", }) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!inputString) {
                inputString = fs.readFileSync(this.filePath, { encoding: "utf-8" });
            }
            if (!webviewScript) {
                webviewScript = utility.addFileProtocol(path.resolve(utility.extensionDirectoryPath, "./out/src/webview.js"), isForVSCode);
            }
            if (!body) {
                // default body
                body = `
    ...
    `;
      ...
      <head>
        ...
        ${styles}
        <link rel="stylesheet" href="${utility.addFileProtocol(path.resolve(utility.extensionDirectoryPath, "./styles/preview.css"), isForVSCode)}">
    ...
    resolveFilePath(filePath = "", relative) {
        if (filePath.match(this.protocolsWhiteListRegExp) ||
            ...
            if (relative) {
                ...
                return utility.addFileProtocol(path.resolve(this.projectDirectoryPath, "." + filePath), this.isForVSCodePreview);
            }
        }
        else {
            if (relative) {
